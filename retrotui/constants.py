...
ICONS = [
    ...
    {
        "label": "Mines",
        "action": AppAction.MINESWEEPER,
        "art": ["\u250c\u2500\u2500\u2510", "\u2502\u2692\u2692\u2502", "\u2514\u2500\u2500\u2518"],
        "category": "Games",
    },
    {"label": "Solitaire", "action": AppAction.SOLITAIRE, "art": ["+--+", "|<>|", "+--+"], "category": "Games"},
    {"label": "Snake", "action": AppAction.SNAKE, "art": ["+--+", "|~~|", "+--+"], "category": "Games"},
    {"label": "Chars", "action": AppAction.CHARMAP, "art": ["+--+", "|¤ |", "+--+"], "category": "Apps"},
...
ICONS_ASCII = [
    {"label": "Files", "action": AppAction.FILE_MANAGER, "art": ["+--+", "|##|", "+--+"], "category": "Apps"},
    {"label": "Notepad", "action": AppAction.NOTEPAD, "art": ["+--+", "|==|", "+--+"], "category": "Apps"},
    {"label": "ASCII Vid", "action": AppAction.ASCII_VIDEO, "art": ["+--+", "|>|#", "+--+"], "category": "Apps"},
    {"label": "Terminal", "action": AppAction.TERMINAL, "art": ["+--+", "|>_|", "+--+"], "category": "Apps"},
    {"label": "Calc", "action": AppAction.CALCULATOR, "art": ["+--+", "|+-|", "+--+"], "category": "Apps"},
    {"label": "Logs", "action": AppAction.LOG_VIEWER, "art": ["+--+", "|LN|", "+--+"], "category": "Apps"},
    {"label": "Procs", "action": AppAction.PROCESS_MANAGER, "art": ["+--+", "|PS|", "+--+"], "category": "Apps"},
    {"label": "Clock", "action": AppAction.CLOCK_CALENDAR, "art": ["+--+", "|CL|", "+--+"], "category": "Apps"},
    ...
    {"label": "Settings", "action": AppAction.SETTINGS, "art": ["+--+", "|**|", "+--+"], "category": "Apps"},
    {"label": "About", "action": AppAction.ABOUT, "art": ["+--+", "| ?|", "+--+"], "category": "Apps"},
    {"label": "Mines", "action": AppAction.MINESWEEPER, "art": ["+--+", "|MM|", "+--+"], "category": "Games"},
    {"label": "Solitaire", "action": AppAction.SOLITAIRE, "art": ["+--+", "|<>|", "+--+"], "category": "Games"},
    {"label": "Snake", "action": AppAction.SNAKE, "art": ["+--+", "|~~|", "+--+"], "category": "Games"},
    {"label": "Chars", "action": AppAction.CHARMAP, "art": ["+--+", "|¤ |", "+--+"], "category": "Apps"},
    {"label": "Clip", "action": AppAction.CLIPBOARD, "art": ["+--+", "|Cb|", "+--+"], "category": "Apps"},
