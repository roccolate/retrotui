...
class BIOS:
    ...
    def run(self):
        ...
        try:
            ...
            y += 1
            safe_addstr(self.stdscr, y, x, f"RetroBIOS v{APP_VERSION} (C) 2026 RetroTUI Corp.", attr)
            y += 2
            ...
            # Always restore blocking mode so a skip path or an exception
            # can't leave the terminal in non-blocking state for the rest
            # of the session.
